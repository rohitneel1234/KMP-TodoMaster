...
fun FavoritesScreen(
    ...
    val favoriteTasks by taskViewModel.favoriteTasks.collectAsState()
    ...
    Scaffold(
        ...
        if (favoriteTasks.isEmpty()) {
            DisplayPlaceholderImage(
                image = Res.drawable.task_favorites_placeholder,
                text = stringResource(Res.string.favorites_placeholder),
                alpha = 0.35f,
