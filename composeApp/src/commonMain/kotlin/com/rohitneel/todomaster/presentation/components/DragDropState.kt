...
fun LazyItemScope.DraggableItem(
    ...
    val current: Float by animateFloatAsState(dragDropState.draggingItemOffset * 0.67f, label = "")
    val previous: Float by animateFloatAsState(dragDropState.previousItemOffset.value * 0.67f, label = "")
    ...
    val draggingModifier = if (dragging) {
        ...
        Modifier.animateItemPlacement(tween(easing = FastOutLinearInEasing))
    }
